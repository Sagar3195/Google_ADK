...
#Load the all environment variables from '.env' file
load_dotenv()
...
greeting_agent = Agent(
    ...
    description= "Handles simple greetings and hellos using the 'say hello' tool.",
    tools= [say_hello],
)
...
farewell_agent = Agent(
    ...
    description= "Handles simple farewells and goodbyes using the 'say_goodbyes' tool.",
    tools = [say_goodbye]
)
